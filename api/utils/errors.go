...
func buildErrors() {
	...
	WrongPasswordError = newError("error while hashing password", 0, http.StatusInternalServerError)
	...
	JWTParsingError = newError("there was an error generating JWT token", 0, http.StatusInternalServerError)
